...
foreach($editData as $data){
 ?>
        ...
        <div class="row">
            <div class="col-sm-6">
		<div class="appTitle">Edit Super Distributor</div>
                   <div>
		   ...
		   <div>
		    <div class="field" style="padding-top:5px;">
            	 ...
            	 <div class="field">
                    <div class="fieldDetail leftFloat" style="width:350px;">
                         ...
                         <div class="fieldLabelSpace1">
                             <input tabindex="6" type="text" maxlength="10" id="mobile" name="data[SuperDistributor][mobile]" value ="<?php if(isset($data))echo $data['SuperDistributor']['mobile']; ?>" readonly/>
            	 ...
            	 <div class="altRow">
              	 <div class="field">           	 
                    ...
                    <div class="fieldDetail">
                        <div class="fieldLabel1 leftFloat"><label for="no_distributors_limit" class="compulsory">No. of distributor limit</label></div>
                        <div class="fieldLabelSpace1">
                        <input type="text" id="no_distributors_limit" name="data[SuperDistributor][no_distributors_limit]" value="<?php if(isset($data))echo $data['SuperDistributor']['no_distributors_limit']; ?>"/>    
                        </div>                    
                  </div>
            	 </div>
            	 </div>
		    ...
		    <div class="field" style="padding:10px 0px;">
                        <div class="fieldDetail leftFloat" style="width:350px;">
                            ...
                            <div class="fieldLabelSpace1">
                                <input type="text" class="form-control" id="rm_name" name="data[SuperDistributor][rm_name]" placeholder="" value="<?php if(isset($data))echo $data['SuperDistributor']['rm_name']; ?>" readonly>
                            </div> 
                 ...
                 <div class="field"  style="padding-top:20px">               		
                    <div class="fieldDetail">
                         ...
                         <div class="fieldLabelSpace1" id="sub_butt">
                         	<?php echo $ajax->submit('Update Super Distributor', array('id' => 'sub', 'tabindex'=>'21','url'=> array('controller'=>'shops', 'action'=>'editSuperDistributorValidation'), 'class' => 'retailBut enabledBut', 'after' => 'showLoader2("sub_butt");', 'update' => 'innerDiv')); ?>
                         	<input type="hidden" name="data[SuperDistributor][id]" value="<?php if(isset($data))echo $data['SuperDistributor']['id']; ?>">
                         </div>                         
                    </div>
                </div>
                <div class="field">    
...
function confirm_super_distributor_edit(){
    var data  = {
        ...
        "data[SuperDistributor][map_lat]" : jQuery("#map_lat").val(),
        "data[SuperDistributor][map_long]" : jQuery("#map_long").val(),
        "data[SuperDistributor][name]" : jQuery("#name").val(),
        "data[SuperDistributor][mobile]" : jQuery("#mobile").val(),
        "data[SuperDistributor][dob]" : jQuery("#dob").val(),
        "data[SuperDistributor][slab_id]" : jQuery("#slab_id").val(),
        "data[SuperDistributor][city]" : jQuery("#city").val(),
        "data[SuperDistributor][state]" : jQuery("#state").val(),
        "data[SuperDistributor][pan_number]" : jQuery("#pan_number").val(),
        "data[SuperDistributor][company]" : jQuery("#company").val(),
        "data[SuperDistributor][address]" : jQuery("#address").val(),
        "data[SuperDistributor][no_distributors_limit]" : jQuery("#no_distributors_limit").val(),
        "data[SuperDistributor][email]" : jQuery("#email").val(),
        "data[SuperDistributor][gst_no]" : jQuery("#gst_no").val(),
        "data[SuperDistributor][rm_id]" : jQuery("#rm_id").val(),
        "data[SuperDistributor][rm_name]" : jQuery("#rm_name").val(),
        "data[SuperDistributor][id]" : jQuery("#sd_id").val()
    }
