...
<html>
    <head>
        <style>
            .tnc{margin-top: 5px;width: 100%;margin:0 auto;}
...
<div class="tnc">
    <p>
        ...
        <span><h3><center>Online Distributor Service Agreement</center></h2></span>   

        <span>THIS AGREEMENT executed as specified herein by the person(s)/Company as described in the Appointment Letter (hereinafter collectively and severally referred to as "The Executants”)</span>  
    ...
    <span><b>MindsArray Technologies Pvt Ltd</b>      </span>
