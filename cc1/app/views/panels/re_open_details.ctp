...
<script>
 jQuery(document).ready(function() {
  ...
  <div class="panel panel-default">
	  <div class="panel-body"><h4>Reopen Transactions Report</h4></div>
  </div>
  ...
  <table class="table table-hover">
    ...
    <tbody>
		...
		<?php $i = 1; foreach ($transDetails as $key => $val){ 
			$ps = '';
		...
		<tr>
			<td><?php echo $i;?></td>
			<td><a target="_blank" href="/panels/transaction/<?php echo $val['vendors_activations']['txn_id'];?>"><?php echo $val['vendors_activations']['ref_code'];?></a></td>
