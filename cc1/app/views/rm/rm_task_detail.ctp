...
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="'/rm/rmTask'">Task</a></li>
  <li class="breadcrumb-item active">Task Detail</li>
</ol>

<form class="form-inline" method="post" action="/rm/rmTaskDetail" style="margin-bottom:1%;">
         ...
         if($rm_task_detail) { 
             foreach($rm_task_detail as $RM) {
                ...
                <tr style="background-color:<?php echo @$background;?> ">
                    ...
                    <td><?php echo $RM['distributor_visited']; ?></td>
                    <td><?php echo $RM['distributor_lead']; ?></td>
                    <td><?php echo $RM['distributor_converted']; ?></td>
                    <td><?php echo $RM['retailer_visited']; ?></td>
                    <td><?php echo $RM['retailer_activated']; ?></td>
                    <?php
                    ...
                    ?>
                    <td><?php echo $RM['other_comments']; ?></td>
                    <?php 
