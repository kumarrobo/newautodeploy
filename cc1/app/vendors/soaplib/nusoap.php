...
class nusoap_base {
    ...
    */
	...
	if($headers){
		...
		$headers = "<soap:Header>".$headers."</soap:Header>";
	}
	// serialize envelope
	return
...
<soap:Header>
	<MobileServiceAccessAuthentication xmlns="http://tempuri.org/">
		<MSAccessID>1</MSAccessID>
		<AuthKey>MSA_VF_Access</AuthKey>
	</MobileServiceAccessAuthentication>
</soap:Header>
<soap:Body>
	<VerifyMobileNo xmlns="http://tempuri.org/"> <strRequestXML>&lt;VerifyMobile&gt;&lt;MobileNo&gt;9099959156&lt;/MobileNo&gt;&lt;/VerifyMobile&gt;</strRequestXML> </VerifyMobileNo>
</soap:Body>
</soap:Envelope>';*/
    }
