...
Class MinifyHelper extends AppHelper{ 
        ...
        function js($assets,$version){ 
            if(Configure::read('MinifyAsset')){ 
               e(sprintf("<script type='text/javascript' src='%s?%s'></script>",$this->_path($assets, 'js'),$version)); 
            } 
            else{ 
        ...
        function css($assets,$version){ 
            if(Configure::read('MinifyAsset')){ 
                e(sprintf("<link type='text/css' rel='stylesheet' href='%s?%s' />",$this->_path($assets, 'css'),$version)); 
            } 
            else{ 
